...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Resources/assets/js/contao-pwa-bundle.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/Resources/assets/js/PushNotificationSubscription.js":
/*!*****************************************************************!*\
  !*** ./src/Resources/assets/js/PushNotificationSubscription.js ***!
  \*****************************************************************/
/*! no static exports found */
...
function asyncGeneratorStep(a,b,c,d,e,f,g){try{var h=a[f](g),i=h.value}catch(a){return void c(a)}h.done?b(i):Promise.resolve(i).then(d,e)}function _asyncToGenerator(a){return function(){var b=this,c=arguments;return new Promise(function(d,e){function f(a){asyncGeneratorStep(h,d,e,f,g,"next",a)}function g(a){asyncGeneratorStep(h,d,e,f,g,"throw",a)}var h=a.apply(b,c);f(void 0)})}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),a}var PushNotificationSubscription=/*#__PURE__*/function(){function a(){var b=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"",c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"";_classCallCheck(this,a),this.isInit=!1,this.debug=!1,this.subscribePath=b,this.unsubscribePath=c}return _createClass(a,[{key:"onLoaded",value:function a(){this.isInit||(document.addEventListener("huh_pwa_push_changeSubscriptionState",this.changeSubscriptionStatus.bind(this)),this.isInit=!0)}},{key:"subscribe",value:function c(){var b=this;this.debug&&console.log("[Push Notification Subscription] Trying to Subscribe"),navigator.serviceWorker.ready.then(/*#__PURE__*/function(){var c=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function c(d){var e,f;return regeneratorRuntime.wrap(function(c){for(;;)switch(c.prev=c.next){case 0:return c.next=2,fetch("./api/notifications/publickey");case 2:return e=c.sent,c.next=5,e.text();case 5:return f=c.sent,c.abrupt("return",d.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:a.urlBase64ToUint8Array(f)}).then(function(a){b.debug&&console.log("[Push Notification Subscription] Successful Subscribed",a.endpoint),fetch(b.subscribePath,{method:"post",headers:{"Content-type":"application/json"},body:JSON.stringify({subscription:a})})}).then(function(){b.setIsSubscribed()}).catch(function(a){document.dispatchEvent(new CustomEvent("huh_pwa_push_subscription_failed",{detail:{reason:a}}))}));case 7:case"end":return c.stop();}},c,this)}));return function(){return c.apply(this,arguments)}}())}},{key:"unsubscribe",value:function b(){var a=this;this.debug&&console.log("[Push Notification Subscription] Trying to unsubscribe"),navigator.serviceWorker.ready.then(function(a){return a.pushManager.getSubscription()}).then(function(b){return b.unsubscribe().then(function(){return a.debug&&console.log("[Push Notification Subscription] Successful Unsubscribed",b.endpoint),fetch(a.unsubscribePath,{method:"post",headers:{"Content-type":"application/json"},body:JSON.stringify({subscription:b})})})}).then(function(){a.setIsUnsubscribed()}).catch(function(a){document.dispatchEvent(new CustomEvent("huh_pwa_push_unsubscription_failed",{detail:{reason:a}}))})}},{key:"setIsUnsubscribed",value:function a(){this.checkPermission()&&(document.dispatchEvent(new Event("huh_pwa_push_isUnsubscribed")),this.debug&&console.log("[Push Notification Subscription] Fired huh_pwa_push_isUnsubscribed"))}},{key:"setIsSubscribed",value:function a(){this.checkPermission()&&(document.dispatchEvent(new Event("huh_pwa_push_isSubscribed")),this.debug&&console.log("[Push Notification Subscription] Fired huh_pwa_push_isSubscribed\""))}},{key:"checkPermission",value:function a(){return"denied"!==Notification.permission||(document.dispatchEvent(new Event("huh_pwa_push_permission_denied")),this.debug&&console.log("[Push Notification Subscription] Fired huh_pwa_push_permission_denied"),!1)}},{key:"changeSubscriptionStatus",value:function b(a){this.debug&&console.log("[Push Notification Subscription] CHANGE Subscription state"),this.checkPermission()&&("subscribe"===a.detail?this.subscribe():"unsubscribe"===a.detail&&this.unsubscribe())}}],[{key:"urlBase64ToUint8Array",value:function g(a){for(var b="=".repeat((4-a.length%4)%4),c=(a+b).replace(/\-/g,"+").replace(/_/g,"/"),d=window.atob(c),e=new Uint8Array(d.length),f=0;f<d.length;++f)e[f]=d.charCodeAt(f);return e}}]),a}();module.exports=PushNotificationSubscription;

/***/ }),

/***/ "./src/Resources/assets/js/PushSubscriptionButtons.js":
/*!************************************************************!*\
  !*** ./src/Resources/assets/js/PushSubscriptionButtons.js ***!
  \************************************************************/
/*! no static exports found */
