...
let PushSubscription = new PushNotificationSubscription(
    HuhPWA.pushNotifications.subscribePath,
    HuhPWA.pushNotifications.unsubscribePath
);
let debug = HuhPWA.debug;
...
window.addEventListener('load', function()
{
    if (!('serviceWorker' in navigator)) {
        ...
        navigator.serviceWorker.register(HuhPWA.serviceWorker.path, {
            scope: HuhPWA.serviceWorker.scope
...
function initializePush()
{
    ...
    if (!HuhPWA.pushNotifications.support)
    {
